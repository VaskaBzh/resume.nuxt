...
const exchangesItems = reactive([
  'binance', 'bybit', 'hitbtc', 'kucoin', 'okx', 'exmo', 'huobi', 'poloniex', 'bittrex', 'bitget'
])
</script>
        ...
        .grid{
            ...
            .grid-item{
                ...
                &.advantages{
                    ...
                    grid-row-start: 3;
                    grid-row-end: 3;
                    .grid-item__name, .grid-item__description{
                        width: 69%;
                    }
                    .button{
                        position: absolute;
        ...
        .about-arbitration{
            .why-us{
                ...
                &__cripto{
                    ...
                    flex-direction: column;
                    .cripto-item{
                        box-shadow: -2px -2px 6px 0px rgba(3, 4, 28, 0.40);
                        &:first-child{
                            margin-bottom: 0;
                        }
                        &:last-child{
